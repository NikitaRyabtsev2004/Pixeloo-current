...
export function useNotifications() {
  ...
  return {
    ...
    showUserCanPlacePixel: () => {
      ...
      showNotification(
        'Доступ ограничен!',
        'В связи с нарушением правил, вы были ограничены к доступам на сервера (Срок действия 24ч.). В течении времени блокировки вам доступна только одиночная игра. При достижении 3-х ограничений аккаунт будет заблокирован',
        'error'
      );
    },
    ...
    showUserBan: () => {
      ...
      showNotification(
        ...
        'Вы были заблокированы в связи с нарушениями правил пользования игры, или в связи многочисленными ограничениями к доступу из-за нарушений правил игры. Все сервера включая одиночную игры недоступны.',
        'error'
      );
    },
  };
